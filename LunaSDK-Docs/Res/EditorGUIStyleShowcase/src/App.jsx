  ...
  return (
    ...
    >
      ...
      <main className="content">
        ...
        >
          <div className="overview-banner">
            <div>
              ...
              <p>Four concrete leaf Styles map palette and input density onto the existing <code>Luna::EditorGUI</code> package.</p>
            </div>
        ...
        <Section id="primitives" eyebrow="EditorGUITest · Primitives" title="Type, imagery, progress, and system light" description="Foundational drawing and semantic feedback, including the proposed LED primitive for tool status.">
          <div className="card-grid three-columns typography-grid">
            ...
            <Card title="Built-in Core icons" note="The exact 112 names embedded by Luna::EditorGUI" className="span-three icon-catalog-card">
              <BuiltInIconCatalog />
            </Card>
          </div>
        </Section>

        <Section id="buttons" eyebrow="EditorGUITest · Buttons" title="Actions and choices" description="Raised actions, recessed selection wells, explicit keyboard focus, and states that never depend on hover alone.">
        ...
        <Section id="input" eyebrow="EditorGUITest · Input" title="Text, numeric, slider, and color editing" description="Inset fields communicate editability. Focus, read-only, disabled, and validation states remain visually distinct.">
          <div className="card-grid two-columns">
        ...
        <Section id="layouts" eyebrow="EditorGUITest · Layouts" title="Flex, grid, canvas, focus scope, and tabs" description="The visual system scales without changing layout semantics or stable element identity.">
          <div className="card-grid two-columns">
        ...
        <Section id="scroll" eyebrow="EditorGUITest · Scroll Views" title="Overlay and reserved scrollbars" description="Compact mouse mode favors overlay scrollbars; touch mode keeps broad, visible affordances.">
          <div className="card-grid two-columns">
        ...
        <Section id="tables" eyebrow="EditorGUITest · Tables" title="Dense, resizable data" description="Readable rows, clear selection, subtle zebra hierarchy, and wide drag targets around thin splitters.">
            ...
            <div className="table-wrap">
              <table>
                ...
                <tbody>{[
                  ...
                  ["0004", "EditorGUI::State", "Interface", "2.8 MB", "1,264", "Resident", "success"],
        ...
        <Section id="overlay" eyebrow="EditorGUITest · Overlay" title="Menus, popup, tooltip, and dialog layers" description="Transient surfaces use stronger elevation while preserving the same rounded, tactile material vocabulary.">
          <div className="card-grid two-columns">
            ...
            <Card title="Popup & tooltip" note="Independent GUI layers in the target runtime">
        ...
        <Section id="workspace" eyebrow="EditorGUITest · Workspace" title="Docked editor composition" description="Visual target for dock tabs, splitters, floating panels, viewport tools, console, and status feedback; drag and resize behavior remains a runtime concern." wide>
      ...
      <aside className="token-panel">
        ...
        <div className="token-section callout"><Info size={18} /><p>Soft shadows are a visual target. Current GUI/VG draw commands need layered primitives or a future shadow/blur decision.</p></div>
      </aside>
    </div>
  );
}
