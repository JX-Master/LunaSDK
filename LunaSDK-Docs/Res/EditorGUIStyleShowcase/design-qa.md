...
1. Initial pass established the selected Soft Workshop visual direction, complete EditorGUITest category coverage, the four leaf Styles, real DCC assets, and functional overlay examples.
...
- Soft shadow/elevation is a target-language property; GUI/VG still needs layered primitives or a future shadow/blur primitive.
