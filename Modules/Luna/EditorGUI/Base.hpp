...
#ifndef LUNA_EDITOR_GUI_API
#define LUNA_EDITOR_GUI_API
#endif
...
namespace Luna
{
    namespace EditorGUI
    {
        //! @addtogroup EditorGUI Editor GUI
        //! GUI components tailored for data-editing applications such as DCC software, editors, office software,
        //! and enterprise administration software.
        //! @{

        //! Stable identifier used by EditorGUI package elements and package-owned state.
        using id_t = GUI::id_t;
        ...
        struct TextDesc
        {
            ...
            f32 font_size = 0.0f;
            //! Optional registered GUI font ID. Empty names use the bound style value.
            Name font;
        };
        ...
        struct ScrollViewDesc
        {
            ...
            //! Maximum expected per-frame scroll displacement used by GUI visible-range queries.
        ...
        struct TableDesc
        {
            ...
            //! @remark Disabled by default to match @ref GUI::TableLayoutDesc::clip_children.
        ...
        //! Reports package work performed after GUI input routing.
        ...
        //! Gets the EditorGUI package module object.
        //! @return Returns the EditorGUI package module object.
        LUNA_EDITOR_GUI_API Module* module_editor_gui();

        //! Resolves current-frame widget actions after @ref GUI::IContext::route_input.
        //! @param[in] context The GUI context containing the current element tree and routed input.
        ...
        //! GUI draw-command generation for the current frame.
        ...
        LUNA_EDITOR_GUI_API RV layout_tree(GUI::IContext* context, const GUI::ElementHandle& root, const RectF& rect);

        //! Checks whether an element handle is valid in the current frame.
        //! @param[in] context The GUI context that owns @p item.
