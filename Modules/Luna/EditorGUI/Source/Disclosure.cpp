...
namespace Luna
{
    namespace EditorGUI
    {
        namespace Internal
        {
            ...
            static GUI::MeasureResult measure_disclosure(GUI::IContext* context,
                ...
                GUI::DrawPhase, void* userdata)
            {
                ...
                {
                    GUI::DrawCommand dot;
                    dot.type = GUI::DrawCommandType::rounded_rect;
                    dot.rect_reference = GUI::DrawCommandRectReference::element;
            ...
            static bool disclosure(GUI::IContext* context, id_t id, const c8* label,
                const GUI::LayoutConfig& layout, const DisclosureDesc& desc, bool header,
                ...
                GUI::ElementHandle* out_handle)
            {
                ...
                GUI::ElementHandle element = begin_element(context, id, label ? label : "Disclosure", layout);
        ...
        LUNA_EDITOR_GUI_API bool collapsing_header(GUI::IContext* context, id_t id, const c8* label,
            const GUI::LayoutConfig& layout, const DisclosureDesc& desc, GUI::ElementHandle* out_handle)
        {
        ...
        LUNA_EDITOR_GUI_API bool tree_node(GUI::IContext* context, id_t id, const c8* label,
            TreeNodeFlag flags, u32 indent_depth, const GUI::LayoutConfig& layout,
            const DisclosureDesc& desc, GUI::ElementHandle* out_handle)
        {
