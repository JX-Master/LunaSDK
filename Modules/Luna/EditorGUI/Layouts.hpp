...
namespace Luna
{
    namespace EditorGUI
    {
        ...
        //! @param[in] context The GUI context containing the open layout scope.
        ...
        LUNA_EDITOR_GUI_API void end_h_layout(GUI::IContext* context, const GUI::ElementHandle& element,
            const GUI::FlexLayoutDesc& desc = GUI::FlexLayoutDesc());
        ...
        LUNA_EDITOR_GUI_API void end_canvas_layout(GUI::IContext* context, const GUI::ElementHandle& element,
            const GUI::CanvasLayoutDesc& desc);
        ...
        LUNA_EDITOR_GUI_API GUI::ElementHandle begin_focus_scope(GUI::IContext* context, id_t id, const c8* label,
            const GUI::LayoutConfig& layout = GUI::LayoutConfig());
        //! Ends a focus scope and arranges its direct children vertically.
        //! @param[in] context The GUI context containing the open focus scope.
        //! @param[in] element The scope element returned by @ref begin_focus_scope.
        LUNA_EDITOR_GUI_API void end_focus_scope(GUI::IContext* context, const GUI::ElementHandle& element);
        ...
        LUNA_EDITOR_GUI_API GUI::ElementHandle begin_table_layout(GUI::IContext* context, id_t id, const c8* label,
            const GUI::LayoutConfig& layout = GUI::LayoutConfig(), const TableDesc& desc = TableDesc());
        //! Sets the column tracks used by the current table layout.
        //! @param[in] context The GUI context containing the open table scope.
        ...
        LUNA_EDITOR_GUI_API bool begin_table_row(GUI::IContext* context,
            const GUI::TableTrackDesc& row = GUI::TableTrackDesc());
        //! Ends the current table row and attaches newly submitted direct children to consecutive cells.
        //! @param[in] context The GUI context containing the open table row.
        ...
        LUNA_EDITOR_GUI_API void end_table_layout(GUI::IContext* context, const GUI::ElementHandle& element);
        ...
        //! @param[in] context The GUI context containing the open scroll-view scope.
        ...
        //! @param[in] context The GUI context that owns @p scroll_view.
        ...
        LUNA_EDITOR_GUI_API GUI::ElementHandle begin_tab_bar(GUI::IContext* context, id_t id, i32* selected_index,
            const GUI::LayoutConfig& layout = GUI::LayoutConfig(), const TabBarDesc& desc = TabBarDesc());
        //! Begins one tab item and returns whether its content should be submitted this frame.
        //! @param[in] context The GUI context containing the open tab bar.
        ...
        LUNA_EDITOR_GUI_API bool begin_tab_item(GUI::IContext* context, id_t id, const c8* label,
            const TabItemDesc& desc = TabItemDesc());
        //! Ends the current selected tab item content scope.
        //! @param[in] context The GUI context containing the open tab content scope.
        LUNA_EDITOR_GUI_API void end_tab_item(GUI::IContext* context);
        //! Ends the current tab bar.
        //! @param[in] context The GUI context containing the open tab-bar scope.
