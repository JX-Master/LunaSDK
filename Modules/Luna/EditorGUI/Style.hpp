...
namespace Luna
{
    namespace EditorGUI
    {
        ...
        //! Registers style schemas consumed by the editor EditorGUI package.
        //! @param[in] context The GUI context that stores schemas and styles.
        ...
        //! @param[in] context The GUI context that stores the style.
        ...
        LUNA_EDITOR_GUI_API void set_default_style(GUI::IContext* context,
            const DefaultStyleDesc& desc = DefaultStyleDesc());
    }
}
