...
namespace Luna
{
    namespace EditorGUI
    {
        ...
        //! @param[in] context The GUI context that owns the popup state.
        ...
        //! Begins an open popup as a new GUI layer.
        //! @param[in] context The GUI context receiving the popup layer.
        ...
        LUNA_EDITOR_GUI_API bool begin_popup(GUI::IContext* context, id_t id, const PopupDesc& desc,
            GUI::ElementHandle* out_handle = nullptr);
        //! Ends a popup layer and arranges its content vertically inside @p rect.
        //! @param[in] context The GUI context containing the open popup scope.
        ...
        //! @param[in] context The GUI context receiving the tooltip layer.
        ...
        LUNA_EDITOR_GUI_API bool begin_tooltip(GUI::IContext* context, id_t id,
            const GUI::ElementHandle& owner, const TooltipDesc& desc = TooltipDesc(),
            GUI::ElementHandle* out_handle = nullptr);
        //! Ends a tooltip layer and arranges its content vertically inside @p rect.
        //! @param[in] context The GUI context containing the open tooltip layer.
        ...
        //! @param[in] context The GUI context receiving the tooltip when visible.
        //! @param[in] id Stable tooltip and layer ID.
        //! @param[in] owner Element whose continuous hover state controls tooltip visibility.
        ...
        LUNA_EDITOR_GUI_API GUI::ElementHandle set_item_tooltip(GUI::IContext* context, id_t id,
            const GUI::ElementHandle& owner, const c8* content, const TooltipDesc& desc = TooltipDesc());

        //! Adds a combo box backed by an integer item index.
        //! @param[in] context The GUI context receiving the element and popup.
        ...
        LUNA_EDITOR_GUI_API GUI::ElementHandle begin_menu_bar(GUI::IContext* context, id_t id,
            const c8* label = nullptr, const GUI::LayoutConfig& layout = GUI::LayoutConfig(),
            const MenuBarDesc& desc = MenuBarDesc());
        //! Ends a menu bar and installs its deferred horizontal layout.
        //! @param[in] context The GUI context containing the open menu-bar scope.
        ...
        //! @param[in] context The GUI context receiving the menu item and optional popup.
        ...
        LUNA_EDITOR_GUI_API bool begin_menu(GUI::IContext* context, id_t id, const c8* label,
            const MenuItemDesc& desc = MenuItemDesc(), GUI::ElementHandle* out_handle = nullptr,
            const GUI::LayoutConfig& layout = GUI::LayoutConfig());
        //! Ends the current menu popup.
        //! @param[in] context The GUI context containing the open menu popup.
        ...
        //! @param[in] context The GUI context containing the open menu-item scope.
        LUNA_EDITOR_GUI_API void end_menu_item(GUI::IContext* context);
        //! Adds one menu item.
        //! @param[in] context The GUI context receiving the item.
        ...
        //! @param[in] context The GUI context receiving the separator.
