...
namespace Luna
{
	...
	//! @brief Represents one self-indexed hash map whose key can be extracted from the value, so that
	...
	public:
		...
		//! the new data table size will be expanded to a minimum value that satisfies requirements.You can specify
		...
		//! @brief Assigns the value to the element with the specified key, or inserts the value pair to the 
