...
namespace Luna
{
	...
	//! @brief Describes one generic structure type.
	...
	//! @brief Describes one enumeration type.
	...
	//! @brief Registers one structure type.
	...
	//! @brief Registers one generic structure type.
	//! @details If one type with the same name or GUID already exists, the new type will not be registered.
	...
	//! @brief Registers one enumeration type.
	//! @details If one type with the same name or GUID already exists, the new type will not be registered.
	...
	//! @brief Gets properties of the specified structure.
	...
	//! @brief Gets the base type of the specified type.
	//! @param[in] type The type to query.
	...
	//! @brief Gets options of the specified enumeration.
	//! @param[in] type The type to query.
	...
	//! @brief Gets the underlying type of the specified enumeration.
	//! @param[in] type The type to query.
	...
	//! @brief Checks if the specified type is a multi-value enumeration type.
	//! @param[in] type The type to query.
	...
	//! @brief Extracts the mapped value of the enumeration, regardless of the underlying type of the enumeration.
	//! @param[in] type The type of the instance.
	...
	//! @brief Sets the enumeration value to the specified mapped value.
	...
	//! @brief Gets the generic structure type from one generic structure instanced type.
	...
	//! @brief Gets the generic arguments used to instantiate one generic structure instanced type.
	//! @param[in] type The type to query.
	...
	//! @brief Gets the generic parameter names of the specified type.
	//! @param[in] type The type to query.
	//! @return Returns the generic arguments of the type.
	...
	//! @brief The default equality comparison function used by the reflection system.
	...
	//! @brief The default hashing function used by the reflection system.
	template <typename _Ty>
	...
	//! @brief The default constructor used by the reflection system.
	template <typename _Ty>
	...
	//! @brief The default destructor used by the reflection system.
	template <typename _Ty>
	...
	//! @brief The default copy constructor used by the reflection system.
	template <typename _Ty>
	...
	//! @brief The default move constructor used by the reflection system.
	template <typename _Ty>
	...
	//! @brief The default copy assignment function used by the reflection system.
	template <typename _Ty>
	...
	//! @brief The default move assignment function used by the reflection system.
	template <typename _Ty>
	...
	//! @brief Registers one structure type to the type system. The structure type must have one @ref lustruct
	...
	//! @brief Registers one enumeration type to the type system. The enumeration type must have one @ref luenum
