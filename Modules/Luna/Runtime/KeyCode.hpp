...
namespace Luna
{
    ...
    enum class KeyCode : u16
    {
        ...
        r_system,
        //! Applications key on Windows, usually at the right of the right Windows key. Not all keyboards have this key.
        apps,
        //! Spacebar key.
        spacebar,
        ...
        //! / key on the number pad.
        numpad_divide,
        //! = key on the number pad (Mac only).
        numpad_equal,
        //! Enter key on the number pad (Mac only, Windows will always return normal enter).
        numpad_enter,
    };
