...
namespace Luna
{
	...
	//! An container that contains key-value pairs using closed-addressing hashing algorithm. This container
	//! allows multiple values with the same key exist in the container.
