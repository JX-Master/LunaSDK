...
namespace Luna
{
    namespace GUI
    {
        ...
        LUNA_GUI_API void sdf_shape_add_operation(Vector<f32>& floats, SDFShapeInstruction operation);

        //! Appends one rectangle primitive to an SDF shape program.
        //! @param[in,out] floats Destination shape floats.
        //! @param[in] rect Primitive bounds in local logical coordinates.
        LUNA_GUI_API void sdf_shape_add_rectangle(Vector<f32>& floats, const RectF& rect);
        ...
        LUNA_GUI_API void sdf_shape_add_rounded_rectangle(Vector<f32>& floats, const RectF& rect,
        ...
        LUNA_GUI_API void sdf_shape_add_circle(Vector<f32>& floats, const Float2U& center, f32 radius);
        ...
        LUNA_GUI_API void sdf_shape_add_ellipse(Vector<f32>& floats, const Float2U& center,
            const Float2U& radii);
        ...
        LUNA_GUI_API void sdf_shape_add_capsule(Vector<f32>& floats, const Float2U& point0,
        ...
        LUNA_GUI_API SDFBufferRange sdf_color_add_solid(Vector<f32>& floats, const Float4U& color,
        ...
        LUNA_GUI_API SDFBufferRange sdf_color_add_linear_gradient(Vector<f32>& floats,
        ...
        //! @param[in] clip Signed-distance clip limits encoded with the instruction.
        //! @return Returns the appended float range, or an empty range for invalid parameters.
        LUNA_GUI_API SDFBufferRange sdf_color_add_radial_gradient(Vector<f32>& floats,
        ...
        //! @param[in] clip Signed-distance clip limits encoded with the instruction.
        //! @return Returns the appended float range, or an empty range for invalid parameters.
        LUNA_GUI_API SDFBufferRange sdf_color_add_conic_gradient(Vector<f32>& floats,
        ...
        //! @param[in] clip Signed-distance clip limits encoded with the instruction.
        //! @return Returns the appended float range, or an empty range for an invalid clip descriptor.
        LUNA_GUI_API SDFBufferRange sdf_color_add_bilinear_gradient(Vector<f32>& floats,
        ...
        //! @return Returns the appended float range, or an empty range for invalid parameters.
        LUNA_GUI_API SDFBufferRange sdf_color_add_shadow(Vector<f32>& floats,
        ...
        LUNA_GUI_API RV validate_sdf_shape_program(Span<const f32> floats,
        ...
        LUNA_GUI_API RV validate_sdf_color_program(Span<const f32> floats,
        ...
        LUNA_GUI_API R<f32> evaluate_sdf_shape(Span<const f32> floats, const Float2U& point);
        ...
        LUNA_GUI_API R<f32> evaluate_sdf_clip(Span<const f32> floats, f32 distance);
        ...
        LUNA_GUI_API R<Float4U> evaluate_sdf_color(Span<const f32> floats,
            const Float2U& point);
    }
}
