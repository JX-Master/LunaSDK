...
namespace Luna
{
    namespace GUI
    {
        ...
        //! @param[in] context The GUI context that owns @p element.
        ...
        LUNA_GUI_API MeasureResult measure_flex(IContext* context, const ElementHandle& element,
        ...
        LUNA_GUI_API RV layout_flex(IContext* context, const ElementHandle& element, const RectF& rect, void* userdata);
        ...
        LUNA_GUI_API RV layout_grid(IContext* context, const ElementHandle& element, const RectF& rect, void* userdata);
        ...
        LUNA_GUI_API MeasureResult measure_grid(IContext* context, const ElementHandle& element,
            const Float2U& available_content_size, void* userdata);
        ...
        LUNA_GUI_API RV layout_canvas(IContext* context, const ElementHandle& element, const RectF& rect, void* userdata);
        ...
        LUNA_GUI_API RV layout_scroll_viewport(IContext* context, const ElementHandle& element, const RectF& rect,
            void* userdata);
        ...
        //! @ref ScrollViewportLayoutDesc::max_scroll_delta and submit only the intersecting content. GUI does
        //! not interpret the resulting child subset as virtualized content.
        LUNA_GUI_API RectF get_scroll_viewport_visible_rect(IContext* context, const ElementHandle& element);
        ...
        LUNA_GUI_API RV layout_table(IContext* context, const ElementHandle& element, const RectF& rect, void* userdata);
