...
namespace Luna
{
    namespace GUI
    {
        ...
        LUNA_GUI_API RV layout_flex(IContext* context, const ElementHandle& element, const RectF& rect,
            void* userdata)
        {
            if(!context)
            {
        ...
        LUNA_GUI_API RV layout_grid(IContext* context, const ElementHandle& element, const RectF& rect,
            void* userdata)
        {
            if(!context)
            {
        ...
        LUNA_GUI_API RV layout_canvas(IContext* context, const ElementHandle& element, const RectF& rect,
            void* userdata)
        {
            if(!context)
            {
        ...
        LUNA_GUI_API RV layout_table(IContext* context, const ElementHandle& element, const RectF& rect,
            void* userdata)
        {
            if(!context)
            {
