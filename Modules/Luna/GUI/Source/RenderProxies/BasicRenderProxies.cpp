    ...
    namespace GUI
    {
            ...
            const NodeRenderState& state, void*)
        {
            ...
            if(selectable->selected || state.hovered || state.active)
            {
                ...
                Float4U color = state.active ? active_color : (state.hovered ? hovered_color : selected_color);
            ...
            if(!selectable->label_layout)
            {
                ...
                Float4U text_color = style_f32x4(ctx, node, Name("gui.selectable.text_color"), Float4U(1.0f));
                ctx.draw_text(RectF(rect.offset_x + 8.0f, rect.offset_y, max(rect.width - 16.0f, 1.0f), rect.height),
            ...
            const NodeRenderState& state, void*)
        {
            ...
            Float4U border_color = state.hovered ?
            ...
            if(checked)
            {
                Float4U check_color = style_f32x4(ctx, node, Name("gui.checkbox.check_color"), Float4U(1.0f));
            ...
            if(!checkbox->label_layout)
            {
                ...
                Float4U text_color = style_f32x4(ctx, node, Name("gui.checkbox.text_color"), Float4U(1.0f));
            ...
            const NodeRenderState& state, void*)
        {
            ...
            Float4U off_track = state.hovered ?
            ...
            Float4U on_track = state.hovered ?
            ...
            if(!toggle->label_layout)
            {
                ...
                Float4U text_color = style_f32x4(ctx, node, Name("gui.switch.text_color"), Float4U(1.0f));
                ctx.draw_text(RectF(rect.offset_x + label_offset, rect.offset_y, max(rect.width - label_offset, 1.0f), rect.height),
                    clip_rect, node.text.c_str(), font_size, text_color, TextAlignment::begin);
            }
        }
            ...
            const NodeRenderState& state, void*)
        {
            ...
            Float4U text_color = style_f32x4(ctx, node, Name("gui.collapsing_header.text_color"), Float4U(1.0f));
            ...
            const NodeRenderState& state, void*)
        {
            ...
            if(tree->selected || state.hovered || state.active)
            {
                ...
                ctx.draw_rect(rect, clip_rect, state.active ? active_color : (tree->selected ? selected_color : hovered_color),
            ...
            Float4U text_color = style_f32x4(ctx, node, Name("gui.tree_node.text_color"), Float4U(1.0f));
            ...
            const NodeRenderState& state, void*)
        {
            ...
            ctx.draw_circle(outer, clip_rect, style_f32x4(ctx, node, Name("gui.radio_button.background"), Float4U(0.10f, 0.12f, 0.15f, 1.0f)));
            if(radio->selected_state())
            {
                ...
                ctx.draw_circle(RectF(outer.offset_x + (outer.width - inner_size) * 0.5f, outer.offset_y + (outer.height - inner_size) * 0.5f, inner_size, inner_size),
                    clip_rect, style_f32x4(ctx, node, Name("gui.radio_button.selected_color"), Float4U(0.34f, 0.58f, 0.92f, 1.0f)));
            }
            if(!radio->label_layout)
            {
                ...
                Float4U text_color = style_f32x4(ctx, node, Name("gui.radio_button.text_color"), Float4U(1.0f));
                ctx.draw_text(RectF(rect.offset_x + label_offset, rect.offset_y, max(rect.width - label_offset, 1.0f), rect.height),
                    clip_rect, node.text.c_str(), font_size, text_color, TextAlignment::begin);
            }
        }
            ...
            const NodeRenderState& state, void*)
        {
            ...
            if(!count) return;
            i32 hover_item = state.hovered ? group->item_at(rect, state.pointer_position) : -1;
            i32 active_item = state.active ? group->item_at(rect, state.pointer_position) : -1;
