...
namespace Luna
{
    namespace GUI
    {
        ...
        struct LayoutCallbackConfig
        {
            ...
            //! @remark GUI does not dispatch callbacks by this value. It is intended for diagnostics and
        ...
        struct ScrollViewportLayoutDesc
        {
            ...
            //! deciding which children to submit. GUI does not apply overscan or implement virtualization
        ...
        {
            //! Let GUI run its automatic navigation behavior.
            automatic,
        ...
        //! Per-frame and cross-frame interaction state produced by GUI input routing.
        ...
        //! Handle returned by GUI element creation APIs.
        struct ElementHandle
        {
            //! Stable element ID.
            id_t id = 0;
