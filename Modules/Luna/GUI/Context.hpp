...
namespace Luna
{
    namespace GUI
    {
        ...
        struct [[Luna::interface("{B5B4D4D6-EFAB-4EB8-9D6B-DA10722CB5FD}")]] IContext : virtual Interface
        {
            ...
            //! Checks whether one key is currently held down in the shared GUI keyboard state.
            ...
            //! @remark This is primarily useful while layout algorithms are being migrated into GUI.
            ...
            //! @remark GUI only routes events to elements. High-level immediate API packages decide how to
            ...
            //! @remark Navigation callbacks can call this to explicitly fall back to GUI automatic behavior.
            ...
            //! @remark GUI stores this metadata for editors and debug tooling. It does not interpret the entry
            //! as widget behavior.
            ...
            //! Gets performance counters collected for the current GUI frame.
