...
namespace Luna
{
    namespace GUI
    {
        ...
        //! host should continue delivering such positions while GUI owns pointer capture.
        LUNA_GUI_API bool ray_to_surface(const Float3U& ray_origin, const Float3U& ray_direction,
