...
namespace Luna
{
    namespace GUI
    {
        ...
        LUNA_GUI_API GUIItemHandle MenuItem(const c8* label, const c8* shortcut = nullptr, bool selected = false, bool enabled = true);
        LUNA_GUI_API GUIItemHandle MenuItem(const c8* label, const c8* shortcut, bool* selected, bool enabled = true);
        ...
        LUNA_GUI_API GUIItemHandle DragFloat(const c8* label, f32* value, f32 speed, f32 min_value, f32 max_value, GUINumericEditFlag flags = GUINumericEditFlag::none);
        LUNA_GUI_API GUIItemHandle DragFloat2(const c8* label, f32* value, f32 speed, f32 min_value, f32 max_value, GUINumericEditFlag flags = GUINumericEditFlag::none);
        LUNA_GUI_API GUIItemHandle DragFloat3(const c8* label, f32* value, f32 speed, f32 min_value, f32 max_value, GUINumericEditFlag flags = GUINumericEditFlag::none);
        LUNA_GUI_API GUIItemHandle DragFloat4(const c8* label, f32* value, f32 speed, f32 min_value, f32 max_value, GUINumericEditFlag flags = GUINumericEditFlag::none);
        LUNA_GUI_API GUIItemHandle DragInt(const c8* label, i32* value, f32 speed, i32 min_value, i32 max_value, GUINumericEditFlag flags = GUINumericEditFlag::none);
        LUNA_GUI_API GUIItemHandle DragInt2(const c8* label, i32* value, f32 speed, i32 min_value, i32 max_value, GUINumericEditFlag flags = GUINumericEditFlag::none);
        LUNA_GUI_API GUIItemHandle DragInt3(const c8* label, i32* value, f32 speed, i32 min_value, i32 max_value, GUINumericEditFlag flags = GUINumericEditFlag::none);
        LUNA_GUI_API GUIItemHandle DragInt4(const c8* label, i32* value, f32 speed, i32 min_value, i32 max_value, GUINumericEditFlag flags = GUINumericEditFlag::none);
