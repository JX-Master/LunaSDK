...
#include "Common.h"
#include "../../Device.hpp"
#include "MetalDevice.generated.hpp"
namespace Luna
{
    namespace RHI
    {
        ...
        struct [[luna::struct("{89ffffe6-a1d6-413e-bb30-3e0562dacddd}")]] Device : IDevice
        {
            ...
            MTLHeapDescriptor* get_heap_desc(MemoryType memory_type, Span<const BufferDesc> buffers, Span<const TextureDesc> textures, ResultCode& err);
