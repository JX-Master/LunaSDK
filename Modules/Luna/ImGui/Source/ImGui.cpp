    ...
    return out_col; 
        ...
        static R<RHI::IPipelineState*> get_pso(RHI::Format rt_format)
        {
            ...
            lutry
            {
                ...
                ps_desc.rasterizer_state = RasterizerDesc(FillMode::solid, CullMode::none, false, true, false, false, false);
                ps_desc.depth_stencil_state = DepthStencilDesc(false, false, CompareFunction::always, 0, 0.0f, 0.0f, false, 0x00, 0x00, DepthStencilOpDesc(), DepthStencilOpDesc());
