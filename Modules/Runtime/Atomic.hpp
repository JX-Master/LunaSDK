...
namespace Luna
{
	...
	inline void atom_store_i32(i32 volatile* dest, i32 v) { *dest = v; }
	inline void atom_store_u32(u32 volatile* dest, u32 v) { *dest = v; }
	inline void atom_store_i64(i64 volatile* dest, i64 v) { *dest = v; }
	inline void atom_store_u64(u64 volatile* dest, u64 v) { *dest = v; }
	inline void atom_store_usize(usize volatile* dest, usize v) { *dest = v; }
	...
	template <typename _Ty>
	inline _Ty* atom_compare_exchange_pointer(_Ty* volatile* dest, void* exchange, void* comperand);
