...
RV run(int argc, const char* argv[])
{
    ...
    lutry
    {
        ...
        strprintf(output_filename, "%s.cso", params.source_name.c_str());
...
namespace Luna
{
    ...
    constexpr u32 SHADER_METAL_NUMTHREADS_X_)");
            ...
            header.append(" = ");
            String str;
            strprintf(str, "%u", result.metal_numthreads_x);
            header.append(str);
            header.append(R"(;
    constexpr u32 SHADER_METAL_NUMTHREADS_Y_)");
            header.append(source_name);
            header.append(" = ");
            strprintf(str, "%u", result.metal_numthreads_y);
            header.append(str);
            header.append(R"(;
    constexpr u32 SHADER_METAL_NUMTHREADS_Z_)");
            header.append(source_name);
            header.append(" = ");
            strprintf(str, "%u", result.metal_numthreads_z);
            header.append(str);
            header.append(R"(;
})");
