    ...
    {
        {
            ...
            const char* s3 = "Sample Dir/Sample Dir2";
            ...
            // attributes.
            lutest(test_flags(p1.flags(), PathFlag::absolute));
            lutest(test_flags(p3.flags(), PathFlag::absolute));
            lutest(!test_flags(p4.flags(), PathFlag::absolute));
...

        {
            ...
            Name filename1 = p1.filename();
            Name filename2 = p2.filename();
            lutest(filename1 == filename2);
            lutest(filename1 == Name("Sample File"));
        }
