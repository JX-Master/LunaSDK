...
local function write_shader_header(source_name, source_file, target_format, entry_point, output_file)
...
namespace Luna
{
    ...
    constexpr u32 SHADER_METAL_NUMTHREADS_X_]] .. source_name .. [[ = 0;
    constexpr u32 SHADER_METAL_NUMTHREADS_Y_]] .. source_name .. [[ = 0;
    constexpr u32 SHADER_METAL_NUMTHREADS_Z_]] .. source_name .. [[ = 0;
}]]
...
function compile_cppsl(shader_file, configs)
    ...
    if target_format == "msl" then
        write_shader_header(source_name, generated_source, "msl", entry_point, output_file)
        return
    end
