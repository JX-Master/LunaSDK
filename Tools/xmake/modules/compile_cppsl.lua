...
local function validate_metal_source(projectdir, source_file, generated_dir, source_name)
    ...
    os.runv("xcrun", {
        ...
        source_file,
        "-o",
        path.join(generated_dir, source_name .. ".air")
    })
end
...
function compile_cppsl(shader_file, configs)
    ...
    if target_format == "msl" then
        validate_metal_source(projectdir, generated_source, generated_dir, source_name)
