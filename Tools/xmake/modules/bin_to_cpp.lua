...
function bin_to_cpp_header_only(bin_file, cpp_header_file)
    local src, errmsg = io.open(bin_file, "rb")
    if src == nil then
        raise(errmsg)
    end
    ...
    local source_data = "// Autogenerated by bin_to_cpp, do not modity.\n#include <Luna/Runtime/Base.hpp>\n\n"
    source_data = source_data .. "namespace Luna\n{\n    inline constexpr u8 " .. var_name .. "_DATA[] = {" .. bin_str .. "};\n    inline constexpr usize " .. var_name .. "_SIZE = sizeof(" .. var_name .. "_DATA);\n}\n"
    
    dst_header:write(source_data)
    dst_header:close()
end